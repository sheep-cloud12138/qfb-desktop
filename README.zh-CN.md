...
<p align="center">
  ...
  一键安装、内置运行时、引导式设置 — 无需接触终端，即可在 Windows 上运行 Qbot AI Agent。
</p>

<p align="center">
  <a href="https://github.com/sheep-cloud12138/qfb-desktop/releases/latest">
    <img src="https://img.shields.io/github/v/release/sheep-cloud12138/qfb-desktop?style=flat-square&color=2563eb&label=%E6%9C%80%E6%96%B0%E7%89%88%E6%9C%AC" alt="最新版本" />
  </a>
  ...
  <a href="https://github.com/sheep-cloud12138/qfb-desktop/releases">
    <img src="https://img.shields.io/github/downloads/sheep-cloud12138/qfb-desktop/total?style=flat-square&color=16a34a&label=%E4%B8%8B%E8%BD%BD%E6%AC%A1%E6%95%B0" alt="下载量" />
  </a>
  <a href="LICENSE">
    <img src="https://img.shields.io/github/license/sheep-cloud12138/qfb-desktop?style=flat-square" alt="许可证" />
  </a>
</p>

<p align="center">
  <img src="resources/demo.gif" alt="Qbot 运行演示（Windows）" width="720" />
</p>
...
**Qbot** 把 OpenClaw 的运行环境封装成标准的 Windows 安装体验。下载一个 `.exe`，完成设置向导，即可从原生桌面应用运行 Qbot，无需手动配置，无需接触终端。

如果你在搜索 **OpenClaw Windows 安装器**、**如何在 Windows 上运行 Qbot**，或者找 **Qbot**，就是这个项目。

## 快速开始

1. 从 [Releases](https://github.com/sheep-cloud12138/qfb-desktop/releases/latest) 下载最新安装包
2. 运行安装程序（文件名与 `package.json` 一致，例如 `Qbot-Setup-0.7.0+openclaw.2026.4.2.exe`）
...
Qbot 是 OpenClaw 生态的**社区维护 Windows 分发版**，属于 OpenClaw 生态的一部分，非核心项目附属机构。
...
| **安装包** | `Qbot-Setup-0.7.0+openclaw.2026.4.2.exe`（见 [Releases](https://github.com/sheep-cloud12138/qfb-desktop/releases/latest) 实际资产名） |
...
从[最新发布页](https://github.com/sheep-cloud12138/qfb-desktop/releases/latest)下载最新的 `Qbot-Setup-*.exe` 并运行即可。无需 `npm`、无需系统级 Node.js、无需输入任何终端命令。
</details>
...
- 桌面端配置：`%APPDATA%\Qbot\config.json`
...
pnpm run package:win   # 输出: dist/Qbot-Setup-<version>.exe
```
